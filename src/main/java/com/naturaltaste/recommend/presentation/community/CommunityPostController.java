...
import com.naturaltaste.recommend.application.usecase.community.UpdateCommunityCommentRequest;
import com.naturaltaste.recommend.application.usecase.community.UpdateCommunityPostRequest;
...
public class CommunityPostController {
    ...
    public CommunityPostResponse update(
        ...
        return communityPostUseCase.update(currentUserId(authentication), postId, request);
    }
    ...
    @PatchMapping("/community/posts/{postId}/comments/{commentId}")
    public CommunityCommentResponse updateComment(
        ...
        return communityPostUseCase.updateComment(currentUserId(authentication), postId, commentId, request);
    }
